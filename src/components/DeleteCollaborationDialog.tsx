...
const DeleteCollaborationDialog = ({ isOpen, onClose, onConfirm, collaborationTitle }: DeleteCollaborationDialogProps) => {
        ...
        <div className="space-y-6 text-center">
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-left">
            <ul className="text-sm text-red-600 space-y-1">
              <li>• La colaboración desaparecerá de la pestaña Colaboraciones</li>
              <li>• La colaboración seguirá existiendo en la pestaña Historial</li>
              <li>• Los datos se conservarán para consulta futura</li>
